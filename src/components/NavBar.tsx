    ...
    <header className="py-6">
      <div className="container-custom flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#" className="text-sm font-medium text-foreground/80 hover:text-primary transition-colors">Log in</a>
        </div>
        <div>
          <Button variant="default" className="bg-primary hover:bg-primary/90 text-white rounded-md px-4">Add to Slack</Button>
        </div>
      </div>
    </header>
  );
