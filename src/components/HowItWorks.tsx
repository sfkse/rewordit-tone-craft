...
const steps = [
  ...
  },
  {
    ...
    description: "Type your message in Slack as you normally would."
  },
  {
    icon: <CheckCircle className="h-12 w-12 text-primary" />,
    title: "Reword and Send",
    description: "Click the Rewordit button, select your tone, and send the improved message."
  }
];
    ...
    <section id="how-it-works" className="section-spacing">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold">How <span className="gradient-text">Rewordit</span> Works</h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Get started in minutes and improve your Slack communication instantly.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {steps.map((step, index) => (
              <div key={index} className="relative z-10 bg-white p-8 rounded-xl shadow-md border border-border/60 flex flex-col items-center text-center">
